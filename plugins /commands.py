...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        #add sticker loading then run 3 sec and delete 
        m=await message.reply_sticker("CAACAgUAAxkBAAFPjoRmcsNN0YS6b1CEDG4Psx0K8ZBxCgACTgYAAv44gFX0uM6EEujuIx4E") 
